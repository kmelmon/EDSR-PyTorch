...
parser.add_argument('--input_lr', type=str,  help='path to low-res input folder', default='Data/PC_Captures/cadmusMultiAA/TrainingDataCadmusMultiAA/AncientTempleRuins/1280x800noAA')
parser.add_argument('--input_hr', type=str,  help='path to high-res input folder', default='Data/PC_Captures/cadmusMultiAA/TrainingDataCadmusMultiAA/AncientTempleRuins/2560x1600noAA')
parser.add_argument('--output_lr', type=str,   help='path to low-res output folder', default='DIV2KAncientTempleRuinsTestnoAA2/DIV2K/DIV2K_train_LR_bicubic/X2')
parser.add_argument('--output_hr', type=str,   help='path to high-res output folder', default='DIV2KAncientTempleRuinsTestnoAA2/DIV2K/DIV2K_train_HR')
...
parser.add_argument('--files_to_copy', type=int,   help='number of files to copy (even distribution), -1 to copy all', default=400)
